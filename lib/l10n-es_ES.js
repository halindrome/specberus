...
,   "validation.html.non-document-error":   "[${subType}] ${message}"
	// heuristic/group
,   "heuristic.group.candidate":          "El grupo de trabajo podría ser <em><a href=\"${url}\">${name}</a></em>."
,   "heuristic.group.not-found":          "No se consiguió identificar un grupo de trabajo responsable de esta especificación."
};
